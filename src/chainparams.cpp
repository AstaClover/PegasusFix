...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("0", "80.211.37.93"));
        vSeeds.push_back(CDNSSeedData("1", "80.211.72.155"));
        vSeeds.push_back(CDNSSeedData("2", "149.28.162.200"));
        vSeeds.push_back(CDNSSeedData("3", "95.179.208.67"));
        vSeeds.push_back(CDNSSeedData("4", "68.183.32.177"));
